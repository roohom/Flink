...
public class OuterJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //左连接
        sourceName.leftOuterJoin(sourceCity)
                .where(0)
                .equalTo(0)
        ...
        //右连接
        sourceName.rightOuterJoin(sourceCity)
                .where(0)
                .equalTo(0)
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Object>() {
                    @Override
                    public Object join(Tuple2<Integer, String> first, Tuple2<Integer, String> second) throws Exception {
                        if (first == null) {
                            return Tuple3.of(second.f0, second.f1, null);
                        } else {
                            return Tuple3.of(second.f0, second.f1, first.f1);
                        }
                    }
                });
        //全外连接
